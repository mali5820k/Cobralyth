...
#ifndef _LLVM_LIBC_SPAWN_H
#define _LLVM_LIBC_SPAWN_H
...
int posix_spawn(pid_t *__restrict, const char *__restrict, posix_spawn_file_actions_t *, posix_spawnattr_t *__restrict, char * const * __restrict, char * const * __restrict) __NOEXCEPT;
