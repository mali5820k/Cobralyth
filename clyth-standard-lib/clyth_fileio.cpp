#include "clyth_fileio.hpp"

/**
 * Returns true or false if a given path exists.
 * @param file_name path
 * @returns bool
 */
bool FileHandler::exists(std::string file_name) {
    std::filesystem::path file_path(file_name);
    return std::filesystem::exists(file_path);
}

/**
 * Returns true or false if a given path is a directory.
 * @param file_name path containing name of file
 * @returns bool
 */
bool FileHandler::isDir(std::string file_name) {
    std::filesystem::path file_path(file_name);
 ...
 */
std::vector<std::string> FileHandler::readLines(std::string file_name) {
 ...
 */
std::vector<std::string> FileHandler::split(std::string input_string, std::string delimitter) {
