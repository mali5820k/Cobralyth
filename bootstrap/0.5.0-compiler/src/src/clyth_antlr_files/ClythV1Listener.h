...
public:
  ...
  virtual void enterGenericParamList(ClythV1Parser::GenericParamListContext *ctx) = 0;
  virtual void exitGenericParamList(ClythV1Parser::GenericParamListContext *ctx) = 0;
  ...
  virtual void enterVisibilityModifier(ClythV1Parser::VisibilityModifierContext *ctx) = 0;
  virtual void exitVisibilityModifier(ClythV1Parser::VisibilityModifierContext *ctx) = 0;
  ...
  virtual void enterLambdaExpression(ClythV1Parser::LambdaExpressionContext *ctx) = 0;
  virtual void exitLambdaExpression(ClythV1Parser::LambdaExpressionContext *ctx) = 0;

  virtual void enterLambdaParamList(ClythV1Parser::LambdaParamListContext *ctx) = 0;
  virtual void exitLambdaParamList(ClythV1Parser::LambdaParamListContext *ctx) = 0;

  virtual void enterLambdaParam(ClythV1Parser::LambdaParamContext *ctx) = 0;
  virtual void exitLambdaParam(ClythV1Parser::LambdaParamContext *ctx) = 0;
  ...
  virtual void enterCurlyLiteral(ClythV1Parser::CurlyLiteralContext *ctx) = 0;
  virtual void exitCurlyLiteral(ClythV1Parser::CurlyLiteralContext *ctx) = 0;

  virtual void enterCurlyEntryList(ClythV1Parser::CurlyEntryListContext *ctx) = 0;
  virtual void exitCurlyEntryList(ClythV1Parser::CurlyEntryListContext *ctx) = 0;

  virtual void enterCurlyEntry(ClythV1Parser::CurlyEntryContext *ctx) = 0;
  virtual void exitCurlyEntry(ClythV1Parser::CurlyEntryContext *ctx) = 0;
  ...
  virtual void enterFixedArrayType(ClythV1Parser::FixedArrayTypeContext *ctx) = 0;
  virtual void exitFixedArrayType(ClythV1Parser::FixedArrayTypeContext *ctx) = 0;

  virtual void enterDynamicArrayType(ClythV1Parser::DynamicArrayTypeContext *ctx) = 0;
  virtual void exitDynamicArrayType(ClythV1Parser::DynamicArrayTypeContext *ctx) = 0;

  virtual void enterFunctionType(ClythV1Parser::FunctionTypeContext *ctx) = 0;
  virtual void exitFunctionType(ClythV1Parser::FunctionTypeContext *ctx) = 0;

  virtual void enterFunctionParamTypeList(ClythV1Parser::FunctionParamTypeListContext *ctx) = 0;
  virtual void exitFunctionParamTypeList(ClythV1Parser::FunctionParamTypeListContext *ctx) = 0;

  virtual void enterGenericType(ClythV1Parser::GenericTypeContext *ctx) = 0;
  virtual void exitGenericType(ClythV1Parser::GenericTypeContext *ctx) = 0;

  virtual void enterGenericArgList(ClythV1Parser::GenericArgListContext *ctx) = 0;
  virtual void exitGenericArgList(ClythV1Parser::GenericArgListContext *ctx) = 0;

  virtual void enterTypeAtom(ClythV1Parser::TypeAtomContext *ctx) = 0;
  virtual void exitTypeAtom(ClythV1Parser::TypeAtomContext *ctx) = 0;
