...
int32_t replace_line(const char* path, int64_t line_index, const char* content);
...
const char* file_read(const char* path, int64_t offset, int64_t max_bytes);
const char* file_read_line(const char* path, int64_t line_index);
